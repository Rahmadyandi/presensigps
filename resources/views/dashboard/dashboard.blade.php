                        ...
                        @if ($penelitian)
                            <li>
                                <div class="item">
                                    ...
                                    <div class="in">
                                        <div>Penelitian : {{ $penelitian->lokasi }}</div>
                                        <div>
                                            <small>{{ date('d-m-Y', strtotime($penelitian->tanggal)) }}</small>
                                        </div>
                                        <span
                                            class="badge badge-{{ $penelitian->verifikasi == 'diterima' ? 'success' : ($penelitian->verifikasi == 'ditolak' ? 'danger' : 'warning') }}">
                                            Status: {{ ucfirst($penelitian->verifikasi) }}
                                        </span>
                                    </div>
                                </div>
                            </li>
